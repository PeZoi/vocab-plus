...
> = {
  slate: {
    bg: 'bg-slate-100 hover:bg-slate-200/80 dark:bg-slate-500/10 dark:hover:bg-slate-500/15',
    text: 'text-slate-700 dark:text-slate-300',
    border: 'border-slate-300/80 dark:border-slate-500/30',
    ring: 'ring-slate-400/30 dark:ring-slate-500/30',
    glow: 'rgba(148, 163, 184, 0.25)',
  },
  lime: {
    bg: 'bg-lime-50 hover:bg-lime-100/90 dark:bg-lime-500/10 dark:hover:bg-lime-500/15',
  ...
  emerald: {
    bg: 'bg-emerald-50 hover:bg-emerald-100/90 dark:bg-emerald-500/10 dark:hover:bg-emerald-500/15',
  ...
  teal: {
    bg: 'bg-teal-50 hover:bg-teal-100/90 dark:bg-teal-500/10 dark:hover:bg-teal-500/15',
  ...
  rose: {
    bg: 'bg-rose-50 hover:bg-rose-100/90 dark:bg-rose-500/10 dark:hover:bg-rose-500/15',
  ...
  amber: {
    bg: 'bg-amber-50 hover:bg-amber-100/90 dark:bg-amber-500/15 dark:hover:bg-amber-500/20',
