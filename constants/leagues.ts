...
export const LEAGUE_TIERS_CONFIG: Record<LeagueTier, LeagueTierMeta> = {
  unranked: {
    ...
    badgeBorder: 'border-slate-400/40 dark:border-slate-500/30',
    glowColor: 'rgba(148, 163, 184, 0.25)',
    gradientText: 'from-slate-500 via-slate-600 to-slate-800 dark:from-slate-400 dark:to-slate-200',
  ...
  iron: {
    ...
    badgeBorder: 'border-zinc-400/40 dark:border-zinc-500/30',
    glowColor: 'rgba(161, 161, 170, 0.35)',
    gradientText: 'from-zinc-600 via-zinc-400 to-zinc-700 dark:from-zinc-400 dark:via-zinc-200 dark:to-zinc-400',
  ...
  bronze: {
    ...
    defaultStayXp: 50,
    badgeBg: 'bg-amber-500/15 dark:bg-amber-800/20',
    badgeText: 'text-amber-700 dark:text-amber-400',
    badgeBorder: 'border-amber-500/40 dark:border-amber-700/40',
    glowColor: 'rgba(217, 119, 6, 0.35)',
    gradientText: 'from-amber-600 via-amber-500 to-amber-700 dark:from-amber-500 dark:via-amber-300 dark:to-amber-600',
  ...
  silver: {
    ...
    defaultStayXp: 80,
    badgeBg: 'bg-slate-400/15 dark:bg-slate-300/15',
    badgeText: 'text-slate-700 dark:text-slate-200',
    badgeBorder: 'border-slate-400/40 dark:border-slate-300/40',
    glowColor: 'rgba(148, 163, 184, 0.35)',
    gradientText: 'from-slate-600 via-slate-400 to-slate-700 dark:from-slate-200 dark:via-white dark:to-slate-300',
  ...
  platinum: {
    ...
    gradientText: 'from-cyan-600 via-teal-500 to-cyan-700 dark:from-cyan-300 dark:via-teal-200 dark:to-cyan-400',
  ...
  emerald: {
    ...
    gradientText: 'from-emerald-600 via-green-500 to-emerald-700 dark:from-emerald-400 dark:via-green-200 dark:to-emerald-500',
  ...
  diamond: {
    ...
    gradientText: 'from-blue-600 via-cyan-500 to-blue-700 dark:from-blue-400 dark:via-cyan-200 dark:to-blue-500',
  ...
  master: {
    ...
    gradientText: 'from-purple-600 via-fuchsia-500 to-purple-700 dark:from-purple-400 dark:via-fuchsia-200 dark:to-purple-600',
  ...
  grandmaster: {
    ...
    gradientText: 'from-rose-600 via-red-500 to-rose-700 dark:from-red-500 dark:via-rose-300 dark:to-red-600',
  ...
  challenger: {
    ...
    gradientText: 'from-amber-600 via-yellow-500 to-amber-700 dark:from-yellow-300 dark:via-amber-100 dark:to-amber-400',
